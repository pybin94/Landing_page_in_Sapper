...
export const ignore = [/^\/banners\/?$/, /^\/blog\.json$/, /^\/blog\/([^/]+?)\.json$/];
...
export const components = [
	...
	{
		js: () => import("../../../routes/safety.svelte")
	},
	{
...
if (typeof window !== 'undefined') {
	import("C:/Users/teaml/Desktop/Landing_page_in_Sapper-main/node_modules/sapper/sapper-dev-client.js").then(client => {
